...
from dataset.v3_ner_dataset import LayoutLMv3Dataset
...
from model.layoutlm_v3.modeling_layoutlmv3 import LayoutLMv3ForTokenClassification
from model.layoutlm_v3.configuration_layoutlmv3 import LayoutLMv3Config
...
def main(args):
    ...
    config.num_labels = 2 * len(ner_labels) + 1
